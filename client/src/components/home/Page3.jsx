    ...
    <div className="lg:h-screen pb-6 bg-[#006AFF]/[0.68] flex flex-col gap-10 lg:gap-20 items-center justify-center">
        ...
        <div className="w-4/5 font-mulish">
            ...
            >
                ...
                <AccordionItem key="2" aria-label="Accordion 2" title="How can I file a complaint?">
                ...
                <AccordionItem key="3" aria-label="Accordion 3" title="How can I access legal aid services?">
                    Each District Legal Services Authority, High Court Legal Services Committee and State Legal Services Authority has a front office where an application can be moved. One can even access and apply on the online portal of NALSA (https://nalsa.gov.in/) or the website of the State Legal Services Authorities.
                </AccordionItem>
                <AccordionItem key="4" aria-label="Accordion 3" title="How can I obtain a will?">
                    A will can be obtained by filing a petition before the court along with a schedule of the property and annexing a copy of the will to the petition as well. It should be expressly prayed to the court to grant probate to carry out the intention of the testator.                
                </AccordionItem>
                <AccordionItem key="5" aria-label="Accordion 3" title="What are the legal implications of thievery?">
                    According to Section 379, Punishment for theft, Whoever commits theft shall be punished with imprisonment of either description for a term which may extend to three years, or with fine or with both.
                </AccordionItem>
            </Accordion>
        </div>
    </div>
