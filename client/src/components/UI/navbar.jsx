...
const navbar = () => {
  return (
    <div className=' bg-white h-auto p-5 w-full top-0 sticky z-10 border-b-4 flex flex-row'>
        ...
        <div className='w-full h-10 gap-2 flex flex-row justify-end align-middle'>
        <img src="images/question.svg" alt="question" />
        <img src="images/settings-line.svg" alt="settings" />
        <img src="images/bell-bold.svg" alt="bell" />
        <Avatar name='Yusuf Sodawala' size='40px' round/>
